...
//            System.out.println(json);
    ...
    protected boolean valLiftRide(String json) {
        Gson gson = new Gson();
        LiftRide lifeRide = gson.fromJson(json, LiftRide.class);
        System.out.println(lifeRide.getTime());
        System.out.println(lifeRide.getLiftID());

        return lifeRide.getTime() != null && lifeRide.getLiftID() != null;
    }
}